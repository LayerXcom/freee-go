...
package freee
// QuotationResponseQuotationQuotationContents struct for QuotationResponseQuotationQuotationContents
type QuotationResponseQuotationQuotationContents struct {
	// 見積内容ID
	Id int32 `json:"id"`
	// 順序
