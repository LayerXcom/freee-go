...
package freee
// TrialPlTwoYearsResponseTrialPlTwoYearsBalances struct for TrialPlTwoYearsResponseTrialPlTwoYearsBalances
type TrialPlTwoYearsResponseTrialPlTwoYearsBalances struct {
	// 勘定科目ID(勘定科目の時のみ含まれる)
	...
	Sections []TrialPlTwoYearsResponseTrialPlTwoYearsSections `json:"sections,omitempty"`
	// 勘定科目カテゴリー名
