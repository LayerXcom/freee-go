 ...
 * @param segmentTagParams セグメントタグの作成
@return SegmentTagResponse
*/
func (a *SegmentTagsApiService) CreateSegmentTag(ctx _context.Context, segmentId int32, segmentTagParams SegmentTagParams) (SegmentTagResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1/segments/{segment_id}/tags"
	localVarPath = strings.Replace(localVarPath, "{"+"segment_id"+"}", _neturl.QueryEscape(parameterToString(segmentId, "")) , -1)
	...
	// body params
	localVarPostBody = &segmentTagParams
...
*/
func (a *SegmentTagsApiService) DestroySegmentsTag(ctx _context.Context, segmentId int32, id int32, companyId int32) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1/segments/{segment_id}/tags/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"segment_id"+"}", _neturl.QueryEscape(parameterToString(segmentId, "")) , -1)
...
// GetSegmentTagsOpts Optional parameters for the method 'GetSegmentTags'
 ...
 * @param companyId 事業所ID
 * @param segmentId セグメントID（1,2,3のいずれか） 該当プラン以外で参照した場合にはエラーとなります。   1: 法人向けプロフェッショナル, 法人向けエンタープライズプラン   2,3: 法人向け エンタープライズプラン 
 * @param optional nil or *GetSegmentTagsOpts - Optional Parameters:
 * @param "Offset" (optional.Int32) -  取得レコードのオフセット (デフォルト: 0)
 * @param "Limit" (optional.Int32) -  取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 500) 
@return InlineResponse20019
*/
func (a *SegmentTagsApiService) GetSegmentTags(ctx _context.Context, companyId int32, segmentId int32, localVarOptionals *GetSegmentTagsOpts) (InlineResponse20019, *_nethttp.Response, error) {
	var (
...
@return SegmentTagResponse
*/
func (a *SegmentTagsApiService) UpdateSegmentTag(ctx _context.Context, segmentId int32, id int32, segmentTagParams SegmentTagParams) (SegmentTagResponse, *_nethttp.Response, error) {
	var (
