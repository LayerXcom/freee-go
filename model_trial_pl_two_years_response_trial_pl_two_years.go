...
package freee
// TrialPlTwoYearsResponseTrialPlTwoYears struct for TrialPlTwoYearsResponseTrialPlTwoYears
type TrialPlTwoYearsResponseTrialPlTwoYears struct {
	// 事業所ID
	...
	Balances []TrialPlTwoYearsResponseTrialPlTwoYearsBalances `json:"balances"`
}
