...
package freee
// TrialPlSectionsResponseTrialPlSectionsBalances struct for TrialPlSectionsResponseTrialPlSectionsBalances
type TrialPlSectionsResponseTrialPlSectionsBalances struct {
	// 勘定科目ID(勘定科目の時のみ含まれる)
	...
	// 部門
	Sections []TrialPlSectionsResponseTrialPlSectionsSections `json:"sections,omitempty"`
	// 勘定科目カテゴリー名
