...
package freee
// QuotationUpdateParams struct for QuotationUpdateParams
type QuotationUpdateParams struct {
	// 事業所ID
	...
	// 見積内容
	QuotationContents []QuotationUpdateParamsQuotationContents `json:"quotation_contents,omitempty"`
}
