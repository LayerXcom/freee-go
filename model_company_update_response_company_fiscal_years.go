...
package freee
// CompanyUpdateResponseCompanyFiscalYears struct for CompanyUpdateResponseCompanyFiscalYears
type CompanyUpdateResponseCompanyFiscalYears struct {
	...
	IndirectWriteOffMethodType bool `json:"indirect_write_off_method_type"`
	// 期首日
