...
> DealResponse CreateDealRenew(ctx, id, renewCreateParams)
...
> DealResponse DeleteDealRenew(ctx, id, renewId, companyId)
...
> DealResponse UpdateDealRenew(ctx, id, renewId, renewUpdateParams)
