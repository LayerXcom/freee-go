...
@return BankResponse
*/
func (a *BanksApiService) GetBank(ctx _context.Context, id int32) (BankResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1/banks/{id}"
...
// GetBanksOpts Optional parameters for the method 'GetBanks'
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetBanksOpts - Optional Parameters:
 * @param "Offset" (optional.Int32) -  取得レコードのオフセット (デフォルト: 0)
 * @param "Limit" (optional.Int32) -  取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 500)
 * @param "Type_" (optional.String) -  サービス種別
@return InlineResponse20013
*/
func (a *BanksApiService) GetBanks(ctx _context.Context, localVarOptionals *GetBanksOpts) (InlineResponse20013, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1/banks"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
