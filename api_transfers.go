...
// CreateTransferOpts Optional parameters for the method 'CreateTransfer'
type CreateTransferOpts struct {
    TransferParams optional.Interface
}
 ...
 * @param optional nil or *CreateTransferOpts - Optional Parameters:
 * @param "TransferParams" (optional.Interface of TransferParams) -  取引（振替）の作成
@return TransferResponse
*/
func (a *TransfersApiService) CreateTransfer(ctx _context.Context, localVarOptionals *CreateTransferOpts) (TransferResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1/transfers"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.TransferParams.IsSet() {
		localVarOptionalTransferParams, localVarOptionalTransferParamsok := localVarOptionals.TransferParams.Value().(TransferParams)
		if !localVarOptionalTransferParamsok {
			return localVarReturnValue, nil, reportError("transferParams should be TransferParams")
		}
		localVarPostBody = &localVarOptionalTransferParams
	}
...
*/
func (a *TransfersApiService) DestroyTransfer(ctx _context.Context, id int32, companyId int32) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1/transfers/{id}"
...
@return TransferResponse
*/
func (a *TransfersApiService) GetTransfer(ctx _context.Context, id int32, companyId int32) (TransferResponse, *_nethttp.Response, error) {
	var (
 ...
 * @param "StartDate" (optional.String) -  振替日で絞込：開始日 (yyyy-mm-dd)
 * @param "EndDate" (optional.String) -  振替日で絞込：終了日 (yyyy-mm-dd)
 * @param "Offset" (optional.Int32) -  取得レコードのオフセット (デフォルト: 0)
 * @param "Limit" (optional.Int32) -  取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 100) 
@return InlineResponse20014
*/
func (a *TransfersApiService) GetTransfers(ctx _context.Context, companyId int32, localVarOptionals *GetTransfersOpts) (InlineResponse20014, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id 取引(振替)ID
 * @param transferParams 取引（振替）の更新
@return TransferResponse
*/
func (a *TransfersApiService) UpdateTransfer(ctx _context.Context, id int32, transferParams TransferParams) (TransferResponse, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &transferParams
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
