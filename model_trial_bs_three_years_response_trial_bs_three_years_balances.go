...
package freee
// TrialBsThreeYearsResponseTrialBsThreeYearsBalances struct for TrialBsThreeYearsResponseTrialBsThreeYearsBalances
type TrialBsThreeYearsResponseTrialBsThreeYearsBalances struct {
	// 勘定科目ID(勘定科目の時のみ含まれる)
