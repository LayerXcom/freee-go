...
type PartnerResponsePartner struct {
	...
	PaymentTermAttributesCutoffDay *int32 `json:"payment_term_attributes[cutoff_day],omitempty"`
	// 支払月
	PaymentTermAttributesAdditionalMonths *int32 `json:"payment_term_attributes[additional_months],omitempty"`
	// 支払日（29, 30, 31日の末日を指定する場合は、32。）
	PaymentTermAttributesFixedDay *int32 `json:"payment_term_attributes[fixed_day],omitempty"`
	// 締め日（29, 30, 31日の末日を指定する場合は、32。）
	InvoicePaymentTermAttributesCutoffDay *int32 `json:"invoice_payment_term_attributes[cutoff_day],omitempty"`
	// 支払月
	InvoicePaymentTermAttributesAdditionalMonths *int32 `json:"invoice_payment_term_attributes[additional_months],omitempty"`
	// 支払日（29, 30, 31日の末日を指定する場合は、32。）
	InvoicePaymentTermAttributesFixedDay *int32 `json:"invoice_payment_term_attributes[fixed_day],omitempty"`
}
