...
package freee
// DealResponseDeal struct for DealResponseDeal
type DealResponseDeal struct {
	// 取引ID
	Id int32 `json:"id"`
	// 事業所ID
	...
	// 取引の+更新行
	Renews []DealResponseDealRenews `json:"renews,omitempty"`
	// 取引の支払行
	Payments []DealCreateResponseDealPayments `json:"payments,omitempty"`
	// 証憑ファイル
	Receipts []DealResponseDealReceipts `json:"receipts,omitempty"`
}
