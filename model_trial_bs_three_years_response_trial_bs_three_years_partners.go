...
package freee
// TrialBsThreeYearsResponseTrialBsThreeYearsPartners struct for TrialBsThreeYearsResponseTrialBsThreeYearsPartners
type TrialBsThreeYearsResponseTrialBsThreeYearsPartners struct {
	// 取引先ID
	Id int32 `json:"id"`
	// 取引先名
