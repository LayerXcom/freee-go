...
func NewReceiptUpdateParams(companyID int32, description string, issueDate string) *ReceiptUpdateParams {
...
type ReceiptResponse struct {
	Receipt DealResponseDealReceipts `json:"receipt"`
}

// DealResponseDealReceipts struct for DealResponseDealReceipts
type DealResponseDealReceipts struct {
	// 証憑ID
	Id int32 `json:"id"`
	...
	User    DealResponseDealUser `json:"user"`
}

// DealResponseDealUser struct for DealResponseDealUser
type DealResponseDealUser struct {
	// ユーザーID
	Id int32 `json:"id"`
	// メールアドレス
