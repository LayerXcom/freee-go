...
// CreateSectionOpts Optional parameters for the method 'CreateSection'
type CreateSectionOpts struct {
    SectionParams optional.Interface
}
 ...
 * @param optional nil or *CreateSectionOpts - Optional Parameters:
 * @param "SectionParams" (optional.Interface of SectionParams) -  部門の作成
@return SectionResponse
*/
func (a *SectionsApiService) CreateSection(ctx _context.Context, localVarOptionals *CreateSectionOpts) (SectionResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1/sections"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.SectionParams.IsSet() {
		localVarOptionalSectionParams, localVarOptionalSectionParamsok := localVarOptionals.SectionParams.Value().(SectionParams)
		if !localVarOptionalSectionParamsok {
			return localVarReturnValue, nil, reportError("sectionParams should be SectionParams")
		}
		localVarPostBody = &localVarOptionalSectionParams
	}
...
*/
func (a *SectionsApiService) DestroySection(ctx _context.Context, id int32, companyId int32) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1/sections/{id}"
...
@return SectionResponse
*/
func (a *SectionsApiService) GetSection(ctx _context.Context, id int32, companyId int32) (SectionResponse, *_nethttp.Response, error) {
	var (
...
*/
func (a *SectionsApiService) GetSections(ctx _context.Context, companyId int32) (InlineResponse2001, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// UpdateSectionOpts Optional parameters for the method 'UpdateSection'
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *UpdateSectionOpts - Optional Parameters:
 * @param "SectionParams" (optional.Interface of SectionParams) -  部門の更新
@return SectionResponse
*/
func (a *SectionsApiService) UpdateSection(ctx _context.Context, id int32, localVarOptionals *UpdateSectionOpts) (SectionResponse, *_nethttp.Response, error) {
	var (
