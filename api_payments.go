 ...
 * @param id 取引ID
 * @param paymentParams 取引（収入／支出）の支払行作成
@return DealResponse
*/
func (a *PaymentsApiService) CreateDealPayment(ctx _context.Context, id int32, paymentParams PaymentParams) (DealResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1/deals/{id}/payments"
	...
	// body params
	localVarPostBody = &paymentParams
...
*/
func (a *PaymentsApiService) DestroyDealPayment(ctx _context.Context, id int32, paymentId int32, companyId int32) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1/deals/{id}/payments/{payment_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"payment_id"+"}", _neturl.QueryEscape(parameterToString(paymentId, "")) , -1)
	...
	if paymentId > 2147483647 {
		return nil, reportError("paymentId must be less than 2147483647")
	}
	if companyId < 1 {
 ...
 * @param id 取引ID
 * @param paymentId 決済ID
 * @param paymentParams 取引（収入／支出）の支払行更新
@return DealResponse
*/
func (a *PaymentsApiService) UpdateDealPayment(ctx _context.Context, id int32, paymentId int32, paymentParams PaymentParams) (DealResponse, *_nethttp.Response, error) {
	var (
	...
	if paymentId > 2147483647 {
		return localVarReturnValue, nil, reportError("paymentId must be less than 2147483647")
	}
